...
public class BaseEndpoints {
	...
	public void verifyNested2ResponseKeyValues(String nestTedCompnent, String key1, String key2, String val,
			Response r) {
		Map<String, Map<String, String>> nestedJSON = r.jsonPath().getMap(nestTedCompnent);
		Map<String, String> nestedJSON2 = nestedJSON.get(key1);
		String actual = String.valueOf(nestedJSON2.get(key2));
		assertThat(actual, is(val));
	}
	...
	public void verifyResponseIsEmpty(Response r) {
		...
		assertThat(response, is(IsNull.nullValue()));
	}
